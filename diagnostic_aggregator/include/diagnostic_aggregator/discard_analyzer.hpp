...
/*!
 *\brief DiscardAnalyzer is does not report any values. It is a subclass of
 *GenericAnalyzer
 *
 * DiscardAnalyzer is a subclass of GenericAnalyzer. It will ignore any value
 *that it matches. It takes the any of the parameters of a GenericAnalyzer.
 *
 * It is useful for configuring an aggregator_node to ignore certain values in
 *the diagnostics.
 *
 *\verbatim
 *<launch>
