...
//		path_ = nsp;
	...
	//  auto  parameters_client_analyzer = std::make_shared<rclcpp::SyncParametersClient>(nh);
	//rclcpp::SyncParametersClient::SharedPtr parameters_client_analyzer = std::make_shared<rclcpp::SyncParametersClient>(nh,nsp);
